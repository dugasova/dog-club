...
const { mockCards } = vi.hoisted(() => ({
  mockCards: [
    { id: 1, code: 'A', rating: 3, desc: 'Banana kibble', price: 30, imgSrc: 'a.png' },
    { id: 2, code: 'B', rating: 5, desc: 'Apple kibble', price: 10, imgSrc: 'b.png' },
    { id: 3, code: 'C', rating: 1, desc: 'Cherry kibble', price: 20, imgSrc: 'c.png' },
  ],
}));
